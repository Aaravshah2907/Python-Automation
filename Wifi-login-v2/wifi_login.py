...
def attempt_login():
    ...
    # Step 3: Extract the magic field
    magic = soup.find('input', {'name': 'magic'})
    magic = magic['value'] if magic else ''

    # Step 4: Extract 4Tredir from original URL
    if '?' in redirect_url:
    ...
    # Step 5: Prepare and send login request
